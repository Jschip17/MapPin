...
//  MapPin
//
//  Created by Joshua Schipull on 11/20/16.
...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let currentBundle : String = Bundle.main.object(forInfoDictionaryKey: "CFBundleIdentifier") as! String
        print(currentBundle)
        ...
        let coordinateSpan = MKCoordinateSpanMake(5.5, 5.5)
